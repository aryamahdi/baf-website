...
WebUI.click(findTestObject('link_Content', [('href') : '/en/corporate/CorporateGovernance/Whistleblowing', ('text') : 'Whistleblowing System']))

'Scroll to "WHISTLEBLOWING SYSTEM" Text'
WebUI.scrollToElement(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[1]/div[1]/ol[1]']), 
    10)

'Verify Text "WHISTLEBLOWING SYSTEM" is Present'
WebUI.verifyElementPresent(findTestObject('lbl_Content', [('text') : 'WHISTLEBLOWING SYSTEM']), 10)

'Verify Description Text "WHISTLEBLOWING SYSTEM" is Present'
