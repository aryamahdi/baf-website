...
'Click Menu "Agricultural Machinery Financing"'
WebUI.click(findTestObject('link_Content', [('href') : '/product/MesinPertanian', ('text') : 'Agricultural Machinery Financing']))

WebUI.verifyElementPresent(findTestObject('lbl_Content', [('text') : 'Agricultural Machinery Financing']), 10)

WebUI.verifyElementPresent(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[1]']), 
    10)

WebUI.verifyElementPresent(findTestObject('lbl_Content', [('text') : 'Check estimated monthly installments for Agricultural Machinery Financing, Simulation Here!']), 
    10)

WebUI.scrollToElement(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[2]/h3[1]']), 
    10)

WebUI.setText(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]']), 
    Keys.chord('70 VW', Keys.ENTER))

WebUI.setText(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]']), 
    Keys.chord('Yanmar', Keys.ENTER))

WebUI.setText(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]']), 
    Keys.chord('Palembang', Keys.ENTER))
...
WebUI.setText(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[5]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]']), 
    Keys.chord('25', Keys.ENTER))

WebUI.setText(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[5]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/input[1]']), 
    Keys.chord('30%', Keys.ENTER))

WebUI.scrollToElement(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/label[1]']), 
    10)

WebUI.click(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[7]/button[1]']))
...
WebUI.verifyElementPresent(findTestObject('lbl_Content', [('text') : '19.145.864']), 10)

WebUI.verifyElementPresent(findTestObject('lbl_Content', [('text') : '165.000.000.00']), 10)

WebUI.scrollToElement(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[2]/div[3]/div[1]/div[1]/div[1]/div[1]/form[1]/div[7]/button[1]']), 
    10)
...
WebUI.scrollToElement(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[5]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[5]']), 
    10)
