...
'Click Menu Order Status'
WebUI.click(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/nav[1]/div[1]/div[1]/div[1]/div[3]/div[1]/a[3]']))

'Verify Order Status is Present'
WebUI.verifyElementPresent(findTestObject('var_Content', [('xpath') : '//body[1]/div[1]/main[1]/main[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]']), 
    10)
